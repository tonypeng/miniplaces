...
def ResNet18(x, is_training, opt):
    ...
    resid_group_1 = resid_group(pool_1, is_training, 3, 64, 2, downsize_factor=1, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
    # Resid group 2, 128 features, scale / 2
    resid_group_2 = resid_group(resid_group_1, is_training, 3, 128, 2, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
    # Resid group 3, 256 features, scale / 2
    resid_group_3 = resid_group(resid_group_2, is_training, 3, 256, 2, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
    # Resid group 4, 512 features, scale / 2
    resid_group_4 = resid_group(resid_group_3, is_training, 3, 512, 2, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
...
def ResNet34(x, is_training, opt):
    ...
    # Resid group 1, 64 features, scale / 2
    resid_group_1 = resid_group(pool_1, is_training, 3, 64, 3, downsize_factor=1, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
    # Resid group 2, 128 features, scale / 2
    resid_group_2 = resid_group(resid_group_1, is_training, 3, 128, 4, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
    # Resid group 3, 256 features, scale / 2
    resid_group_3 = resid_group(resid_group_2, is_training, 3, 256, 6, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
    # Resid group 4, 512 features, scale / 2
    resid_group_4 = resid_group(resid_group_3, is_training, 3, 512, 3, init_stddev=_CONV_WEIGHT_STD_DEV, weight_decay=weight_decay, activation=activation)
